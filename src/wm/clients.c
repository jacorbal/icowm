 ...
 * inside its frame, e.g., @a ci_create_decorations,
 ...
 * this instance's cleanup destroys that frame.  A no-op for an
 * already-undecorated client (@c frame already @c 0), whose window
 * already sits directly under root with nothing to undo.
 *
 * @param client Client to release
 *
 * @note No-op if @p client, its connection, or its window is already
 *       gone
 ...
 *       across every desktop of every managed surface
 */

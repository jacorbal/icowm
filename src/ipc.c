...
/* Clear every connected client slot, for test harnesses only; see
 * this function's own comment in 'ipc.h' */
...
/* Directly occupy a client slot, for test harnesses only; see this
 * function's own comment in 'ipc.h' */
...
/* Directly set the listening-socket descriptor, for test harnesses
 * only; see this function's own comment in 'ipc.h' */

 ...
 * monitor in a given direction, rather than each defining its
 ...
 * desktop-cycle keybind's equivalent, switching the view itself
 ...
 * @c cmds/client/geom.c; unlike a desktop, a monitor's real,
 * physical

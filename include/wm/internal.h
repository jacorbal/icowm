 ...
 *
 * Declares the singleton @c wm_td pointer that is defined in @c wm.c,
 * and helpers shared by more than one of @c wm/shutdown.c,
 ...
 * @note All @c wm sub-modules access it through this declaration
 */
extern wm_td *wm;

 ...
 * top-level context menu that offers this action on a client (the
 * window menu, and the icon menu).
 *
 ...
 *         pan, or for a sticky client, which belongs to no one page;
 *         either way @p out_entries and @p out_state are left untouched
 *
